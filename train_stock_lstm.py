        ...
        for stock in by_stock:
            ...
            for rec_date in (c.start + timedelta(days=n) for n in range((c.end - c.start).days)):
                ...
                try:
                    ...
                    if ac.size > 0 and ac.values[0] != 'null':
                        daily_return = (float(ac) - lastAc) / lastAc
...
class StockLSTM(object):
    ...
    def __init__(self, is_training, config):
        ...
        lstm_cell = BasicLSTMCell(size, forget_bias=0.0)
...
def main(config_size='small', num_epochs=10):
    ...
    def run_epoch(session, m, data, eval_op, verbose=False):
        ...
        costs = 0.0
        iters = 0
        ((t1, t2), (t3, t4)) = m.initial_state
        state = (t1.eval(), t2.eval(), t3.eval(), t4.eval())
